                                 ...
                                 <div class="row">
                                    <div class="col-md-6">
                                       <div class="form-group">
                                          ...
                                          <input type="text" class="form-control" placeholder="Card ID" name="id_number" value="{{$user->id_number}}">
                                       </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                       <div class="form-group">
                                          ...
                                          <input type="text" class="form-control" placeholder="Member Name" name="name" value="{{$user->name}}">
                                       </div>
                                    </div>
                                 ...
                                 <div class="row">
                                    ...
                                    <div class="col-md-6">
                                       <div class="form-group">
                                          ...
                                          <input type="text" class="form-control" placeholder="Speciality" name="speciality" value="{{$user->speciality}}">
                                       </div>
                                    </div>
                                 </div>
                                 <div class="row">
                                    ...
                                    <select name="role" class="form-control" required>
                                        @foreach($roles as $role)
                                          ...
                                          @else
                                             <option value="{{$role['id']}}" <?= sizeof($user->roles)>0 && $user->roles[0]->id == $role->id ? 'selected' : '' ?>>{{$role['name']}}</option>
                                          @endif
                                        @endforeach
                                    </select>
                                    @error('esturole')
