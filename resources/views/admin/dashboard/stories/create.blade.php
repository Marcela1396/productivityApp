                                                ...
                                                <div>
                                                    <table class="table">
                                                        <thead>
                                                            ...
                                                            <th scope="col" style="text-align: center"> <b> <i class="fa fa-users"></i> Members : {{$team->name}}  </b> </th>
                                                    </div> </th>
                                                        </thead>
                                                        @php
                                                            $a = 1;
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td> 
                                                                    <select name="{{'member_id_'.$d->dod_id}}"  id="members" class="form-control" required>
